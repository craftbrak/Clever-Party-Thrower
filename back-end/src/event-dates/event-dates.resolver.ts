...
export class EventDatesResolver {
  ...
  @Mutation(() => EventDate)
  createEventDate(@Args('createEventDateInput') createEventDateInput: CreateEventDateInput) {
  ...
  @Mutation(() => EventDate)
  updateEventDate(@Args('updateEventDateInput') updateEventDateInput: UpdateEventDateInput) {
    return this.eventDatesService.update(updateEventDateInput.id, updateEventDateInput);
  }

  @Mutation(() => EventDate)
  removeEventDate(@Args('id', { type: () => Int }) id: number) {
