    ...
    \begin{frame}
        ...
        \begin{columns}
            ...
            \begin{column}{1\textwidth}
                \begin{flushleft}
                    \includegraphics[width=0.21\textwidth]{imgs/selfhost}\label{fig:figure8}
                    \includegraphics[width=0.16\textwidth]{imgs/privacy}\label{fig:figure9}
                    \includegraphics[width=0.13\textwidth]{imgs/Open_Source_Initiative_keyhole.svg}\label{fig:figure7}
                \end{flushleft}
            \end{column}
        \end{columns}
...
%        Le backend est la partie qui a demandé le plus de travail
    ...
    \begin{frame}
        ...
        \begin{columns}
            ...
            \begin{column}{0.5\textwidth}
                \begin{flushleft}
                    \includegraphics[width=0.7\textwidth]{imgs/frontToBack}\label{fig:diagram}
                \end{flushleft}
            \end{column}
        \end{columns}
